...
public class MadPrompt
{
     ...
     *
     * A MadPrompt stores the position of the MadWord in the story, and the string
     * from the MadDictionary that should be used to prompt the user. In our posted
     * example MadLib, the first MadPrompt would indicate that the string to prompt
     * with is "person at work" and that it is for the second word of the story.
     *
