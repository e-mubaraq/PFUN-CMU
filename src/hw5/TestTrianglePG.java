...
/**
 * This program draws a filled triangle.
 * 
...
public class TestTrianglePG
{
    public static void main(String[] args) throws IOException
    {
        ...
        String str, colorString, dir;
        String [] coordinates;
        
        // Create your shape and call the constructor. Call your variable shape.
        // ---------- You write the code here:
        TrianglePG shape = new TrianglePG(new Point(centerX,centerY), width, height, color);   
        ...
        while(!str.equals(""))
        {
            ...
            System.out.print("Please enter the direcction of your triangle: ");
            dir = keyboard.readLine();
